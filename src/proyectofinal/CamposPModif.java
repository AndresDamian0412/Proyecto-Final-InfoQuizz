 ...
 * @author andre
 */
public class CamposPModif extends javax.swing.JPanel {
    
    private static int Posicion;
    /**
     * Creates new form CamposPModif
     */
    public CamposPModif() {
        initComponents();
        setSize(1017,530);
    ...
    private void SaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SaveActionPerformed
        ...
        try{
            ...
            AccesoAleatorioP.setPregunta(Posicion,new Pregunta(tema,subtema,prg,r1,bres1,r2,bres2,r3,bres3));
